...
class Chatpage extends StatefulWidget {
 ...
 final String doctorN;
  ...
  const Chatpage({Key key, this.idDep, this.instName, this.depName,this.instId, this.headId, this.gender, this.doctorN}) : super(key: key);
...
class _ChatpageState extends State<Chatpage> {
    ...
    if (msg.isNotEmpty) {
      ...
      Firestore.instance.runTransaction((transaction) async {
        await transaction.set(ref, {
          "senderId": widget.headId,
          "anotherUserId": widget.instId,
  ...
  buildItem(doc) {
    ...
    final borderRadius = BorderRadius.all(radius);
       bool isMe = doc['senderId'] == widget.headId;
